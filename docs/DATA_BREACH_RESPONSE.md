# Data Breach Response Plan — GENEVIEVE Grey Nomads
...
2. Revoke or rotate exposed Stripe, Vercel, Neon, GitHub or other credentials.
...
Contact affected processors such as Stripe, Vercel or Neon promptly and preserve their incident references. Confirm which party holds relevant logs and what remediation has occurred.
