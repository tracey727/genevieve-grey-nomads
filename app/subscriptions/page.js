...
export const metadata = { title: 'Subscription & Refund Policy | GENEVIEVE — Budget Traveller' };

export default function SubscriptionPolicyPage() {
  return (
    <Shell current="My Trip">
      <article className={`panel ${styles.card}`}>
        <p className="eyebrow">GENEVIEVE — Budget Traveller</p><h2>Subscription & Refund Policy</h2>
