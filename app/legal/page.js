...
export default function LegalPage() {
  return (
    <Shell current="My Trip">
      <section className="page-heading"><p className="eyebrow">Legal</p><h2>Clear rules, not fine-print traps</h2><p>The legal information for GENEVIEVE Grey Nomads is kept in plain English and linked before subscription purchase.</p></section>
